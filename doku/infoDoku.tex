...
\begin{attribut}{interruptsRoad}
	...
	\dbeschreibung{Zeigt auf die nächste Punktlokation nach einer Unterbrechnung im Straßenverlauf, wie z.b. durch den intersectioncode}
\end{attribut}
...
\todo{Eventuell hierfür eine Grafik basteln}
...
Die Datensätze sind stellenweise nicht genau skaliert. Da bei der Berechnung nur die Luftlinien zwischen Punkten berechnet werden ergibt sich eine Ungenauigkeit in den Berechnungen. Diese Ungenauigkeit ist aber zu vernachlässigen.
...
Beim Überprüfen der Datensätze ist uns ebenfalls aufgefallen das die Kreuzungen der Straßen, die wir als Abfahrt behandeln, nicht unbedingt genau an dieser Stelle tatsächlich existieren. Das bedeutet das jedes Mal wenn eine Straße gewechselt wird die Berechnung eventuell sich um einige hundert Meter unterscheiden können. Dies ist jedoch eher selten der Fall. Als Beispiel dient hier die Abfahrt Saarbrücken Unner die als Intersectioncode die B406 hat. jedoch kann man auf dem folgenden Bild sehen wie weit sich die eigentliche Ausfahrt von der der Datensätze unterscheidet.
...
Bei dem oben gezeigten Szenario handelt es sich um die folgende Punktlokation.
