...
Die Objekte werden dynamisch allokiert und Pointer auf sie werden in einem Vector und in einer Map gespeichert. Die doppelte Speicherung hat den Vorteil, dass  

\paragraph{Gebietslokationen erstellen}
Im ersten Schritt des Durchlaufs werden die Gebietslokationen eingelesen. 
